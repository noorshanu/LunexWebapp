        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 text-sm max-w-md">
              Disclaimer: Digital currencies involve certain risks and may not be suitable for all investors.
              The value of digital currencies may go down as well as up, and you may lose all or a substantial
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><Link to="/" className="hover:text-white transition-colors">Staking</Link></li>
              <li><Link to="/swap" className="hover:text-white transition-colors">Swap</Link></li>
              <li><Link to="/vote" className="hover:text-white transition-colors">Vote</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
              <span className="text-gray-400 text-sm">Available Soon On</span>
